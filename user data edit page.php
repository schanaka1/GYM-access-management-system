...
<html>
    <head>
        ...
        <title>Edit with MYSQL Database</title>
        ...
        <div class="container">
            ...
            <div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;background-color:#c1dcde;">
                ...
                <form class="form-horizontal" action="user data edit tb.php?id=<?php echo $id?>" method="post">
                    ...
                    <div class="controls">
                        <select name="subscription_plan" value="<?php echo $data['subscription_plan'];?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" value="<?php echo $data['registration_date'];?>">
                    </div>
                </div>
