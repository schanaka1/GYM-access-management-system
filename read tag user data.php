						...
						<td bgcolor="#f9f9f9">
							<table width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
								...
								<tr>
									...
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['subscription_plan'];?></td>
								</tr>
								<tr>
									<td align="left" class="lf">Registration Date</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['registration_date'];?></td>
								</tr>
								<tr>
									<td align="left" class="lf">Expiry Date</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['expiry_date'];?></td>
								</tr>
								<tr>
									<td align="left" class="lf">Access Status</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['access_status'];?></td>
								</tr>
							</table>
						</td>
					</tr>
